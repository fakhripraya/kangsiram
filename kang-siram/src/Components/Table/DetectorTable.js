...
import { DetectedAddresses } from '../../Pages/AutoDetector';
...
const upperHeadCells = [
    ...
    { id: 'empty', sort: true, disablePadding: false, label: '' },
    { id: 'empty2', sort: true, disablePadding: false, label: '' },
    { id: 'empty3', sort: true, disablePadding: false, label: '' },
    { id: 'empty4', sort: false, disablePadding: false, label: '' },
];

const headCells = [
    { id: 'number', sort: false, disablePadding: true, label: 'No' },
    { id: 'name', sort: true, disablePadding: false, label: 'Address ID' },
    { id: 'hasCrow', sort: true, disablePadding: false, label: 'Has Crow' },
    { id: 'needWater', sort: true, disablePadding: false, label: 'Need Water' },
...
export default function DetectorTable() {
    ...
    const rows = DetectedAddresses(handleSelect);
    ...
    return (
        <div className={classes.root}>
            <Paper className={classes.paper}>
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell onClick={() => handleSelect(row.name)} align="center">{row.hasCrow}</TableCell>
                                            <TableCell onClick={() => handleSelect(row.name)} align="center">{row.needWater}</TableCell>
                ...
                <TablePagination
                    rowsPerPageOptions={[1000, 100, 10]}
                    component="div"
                    count={rows.length}
